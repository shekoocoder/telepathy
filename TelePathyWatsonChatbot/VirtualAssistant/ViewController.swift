...
class ViewController: MessagesViewController, NVActivityIndicatorViewable {
    ...
    // Users
    var current = Sender(id: "123456", displayName: "Lisa")
    let watson = Sender(id: "654321", displayName: "TelePathy")
    ...
    func instantiateAssistant() {
        ...
        startAnimating( message: "Connecting to TelePathy", type: NVActivityIndicatorType.ballScaleRipple)
